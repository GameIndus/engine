class Vector2 {
    ...
    public distance(vector: Vector2): number {
        let dx: number = this.x - vector.x;
        let dy: number = this.y - vector.y;
    ...
    public rotateDeg(degreesRotation: number): Vector2 {
        return this.rotate(Maths.degrees2radian(degreesRotation));
    }
    ...
    public rotateByDeg(degreesRotation: number): Vector2 {
        return this.rotateBy(Maths.degrees2radian(degreesRotation));
    }
    ...
    public rotateToDeg(degreesRotation: number): Vector2 {
        return this.rotateTo(Maths.degrees2radian(degreesRotation));
    }

export default class StatsPanel {
    ...
    public create(): void {
        ...
        this._context.fillRect(
            StatsPanel.GRAPH_POS[0], StatsPanel.GRAPH_POS[1],
            StatsPanel.GRAPH_SIZE[0], StatsPanel.GRAPH_SIZE[1],
        );
    ...
    public update(value: number, maxValue: number): void {
        ...
        this._context.fillText(
            ...
            StatsPanel.TEXT_POS[0], StatsPanel.TEXT_POS[1],
        );

        this._context.drawImage(
            this.canvas,
            StatsPanel.GRAPH_POS[0] + PR, StatsPanel.GRAPH_POS[1],
            StatsPanel.GRAPH_SIZE[0] - PR, StatsPanel.GRAPH_SIZE[1],
            StatsPanel.GRAPH_POS[0], StatsPanel.GRAPH_POS[1],
            StatsPanel.GRAPH_SIZE[0] - PR, StatsPanel.GRAPH_SIZE[1],
        );
        ...
        this._context.fillRect(
            ...
            StatsPanel.GRAPH_POS[1], PR, StatsPanel.GRAPH_SIZE[1],
        );

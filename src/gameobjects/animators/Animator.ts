...
export default class Animator {
    ...
    public position(positionTo: Position, duration: number, easing?: Easing,
                    delay?: number, repeats?: number, yoyo?: boolean): Tween {
    ...
    public size(sizeTo: RectangleSize, duration: number, easing?: Easing,
                delay?: number, repeats?: number, yoyo?: boolean): Tween {
        if (this._sizeTween) {

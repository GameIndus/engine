...
export class Sprite extends GameObject {
    ...
    public constructor(game: Game, name: string, ressource: string, position?: Position,
                       size?: number | any, config?: SpriteConfig) {
        super(game, name);
    ...
    public createAnimation(name: string, frames: [number, number], speed: number,
                           loop?: boolean, dir?: string): SpriteAnimation {
    ...
    public render(): void {
        if (this._texture.valid) {
            this.game.graphics.drawTexture(
                this._texture,

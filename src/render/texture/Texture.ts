...
export default class Texture {
    ...
    public constructor(game: Game, sourceName: string | null, frame?: RectangleSize,
                       crop?: Rectangle, repeat?: boolean) {
        this._game = game;

        this._source = game.cache && sourceName && game.cache.getImage(sourceName) ?
            game.cache.getImage(sourceName) : null;

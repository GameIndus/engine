...
export default class SplashScreen {
    ...
    public boot(): void {
        ...
        const debugMode = this.game.debugModeActivated
        const multiplier = debugMode ? 1 : 1000
        ...
        if (
            ...
            if (this._progressElement != null && this._progressReady) {
                ...
                if (this.loader.progress >= 100 && !this._ended) {
                    this._ended = true
                    setTimeout(this.end.bind(this), 700)
                }
